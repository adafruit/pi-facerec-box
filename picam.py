...
Pi camera device capture class for OpenCV.  This class allows
capturing a single image from the pi camera as an OpenCV image.
"""
...
class OpenCVCapture:
    """OpenCV capture object for Pi camera use."""

    def read(self):
        """Read a single frame from the camera and return the
        data as an OpenCV image (which is a numpy array).
        """
