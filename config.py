...
LOCK_SERVO_PIN = 18
# Pulse width value (in microseconds) for the servo at the unlocked and
# locked position. Center should be a value of 1500, max left a value of
# 1000, and max right a value of 2000 -- though some servos swing wider.
...
def get_camera():
    ...
    # OR - use this code for capturing from a webcam:
